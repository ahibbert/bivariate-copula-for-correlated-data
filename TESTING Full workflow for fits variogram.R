...
# set.seed(1)
# dist="NO";a=1;b=1;c=.25;mu1=1;mu2=2;x1=1;x2=0.1;n=1000
# #dist="GA";a=1;b=1;c=NA;mu1=1;mu2=2;x1=1;x2=.1;n=1000
# 
# #Manual single run
...
# 
# # Save the results
# save(list = c("par_estimates", "score_items"), 
#      file = paste0("Data/CoefSimData_", paste(dist, a, b, c, mu1, mu2, x1, x2, n, Sys.Date(), sep = "_"), ".RData"))
# #save(list(par_estimates,score_items),file=paste("Data/CoefSimData_",paste(dist,a,b,c,mu1,mu2,x1,x2,n,Sys.Date(),sep="_"),".png",sep=""))
# 
# 
...
#  list(dist="NO", a=1, b=1, c=0.25, mu1=1, mu2=2, x1=1, x2=0.1, n=1000),
#  list(dist="NO", a=1, b=1, c=0.75, mu1=1, mu2=2, x1=1, x2=0.1, n=1000)
  list(dist="GA", a=.5, b=2, c=0.25, mu1=1, mu2=2, x1=1, x2=0.1, n=1000),
  list(dist="GA", a=1, b=1, c=0.25, mu1=1, mu2=2, x1=1, x2=0.1, n=1000),
  list(dist="GA", a=2, b=.5, c=0.25, mu1=1, mu2=2, x1=1, x2=0.1, n=1000)
)
...
for (param_set_idx in seq_along(input_params_list)) {
  ...
  save_filename <- paste0(
    "Data/CoefSimData_", paste(
      params$dist, params$a, params$b, params$c, params$mu1, params$mu2, params$x1, params$x2, params$n, Sys.Date(),
      sep="_"
    ), ".RData"
  )
  save(list = c("par_estimates", "score_items"), file = save_filename)
}
