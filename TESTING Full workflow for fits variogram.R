...
input_params_list <- list(
  ...
  #list(dist="NO", a=1, b=1, c=0.9, mu1=1, mu2=2, x1=1, x2=0.1, n=1000)
  #list(dist="GA", a=.5, b=2, c=NA, mu1=1, mu2=2, x1=1, x2=0.1, n=1000),
  #list(dist="GA", a=1, b=1, c=NA, mu1=1, mu2=2, x1=1, x2=0.1, n=1000),
  #list(dist="GA", a=2, b=.5, c=NA, mu1=1, mu2=2, x1=1, x2=0.1, n=1000),
  list(dist="PO", a=NA, b=.2, c=5, mu1=.5, mu2=5, x1=1, x2=0.1, n=1000)
  #list(dist="PO", a=NA, b=5, c=.2, mu1=.5, mu2=.5, x1=1, x2=0.1, n=1000),
  #list(dist="PO", a=NA, b=.2, c=5, mu1=.5, mu2=5, x1=1, x2=0.1, n=1000),
  #list(dist="PO", a=NA, b=5, c=.2, mu1=.5, mu2=.5, x1=1, x2=0.1, n=1000),
)
